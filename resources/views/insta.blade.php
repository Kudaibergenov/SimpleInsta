...
<html>
<head>
	<title>Laravel Instagram API </title>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					<input type="text" id="username" name="username" class="form-control" placeholder="Введите имя пользователя" value="{{ old('username') }}">
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
	  ...
	  <div class="panel-body">
			<table class="table table-bordered">
				...
				<tbody>
					...
					@else
					   <tr>
					    <td colspan="4">Пока нет данные.</td>
					   </tr>
					@endif
				</tbody>
			</table>
